...
def train():
    ...
    val_gen = batchGenerator(data_path = params['val_dataset_path'], input_size = params['image_size'], batch_size = params['batch_size'], random = True)
    train_gen, val_gen = threadsafe_iter(train_gen), threadsafe_iter(val_gen)
    ...
    if(isTrainClassify):
        ...
        classify_model.fit_generator(train_gen,
